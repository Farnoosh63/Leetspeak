describe('myfunction', function() {
  it("is false for XXX", function() {
    expect(myfunction(example)).to.equal(false);
  });
  ...
  // });
  //
  // it("is false for input that are negative", function() {
  //   expect(leapYear(-2016)).to.equal(false);
  // });
});
